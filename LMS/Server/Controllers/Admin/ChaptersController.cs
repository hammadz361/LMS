...
namespace LMS.Server.Controllers.Admin
{
    ...
    public class ChaptersController : ControllerBase
    {
        ...
        {
            return await _context.Chapters.Include(x => x.Subject).ToListAsync();
        }
        ...
        {
            var chapter = await _context.Chapters.Include(x => x.Subject).Where(x => x.ChapterId == id).FirstOrDefaultAsync();
